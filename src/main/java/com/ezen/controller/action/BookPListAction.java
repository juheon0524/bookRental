...
public class BookPListAction implements Action {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, Exception {
		String url = "/bookPList.jsp";
...
//		List<BookVO> bookList = bDao.selectAllBooksByRentalCnt();
		List<BookVO> bookList = bDao.selectAllBooksByRentalCnt(paging.getStartNum(),paging.getEndNum()); //page 관련 추가
