...
public class SubscrUpdateFormAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, Exception {
		...
		String url = "/subscrUpdate.jsp";
		int subscrid = Integer.parseInt(request.getParameter("subscrid"));
		
		SubscrDAO sDao = SubscrDAO.getInstance();
		SubscrVO vo = sDao.selectOneBySubscrid(subscrid);
		System.out.println("SubscrVO : " + vo);
		request.setAttribute("subscr", vo);
